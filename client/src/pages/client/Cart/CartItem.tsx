        ...
        <div className="flex flex-col w-full p-[0.75rem] gap-[0.5rem] bg-[#f2f2f2]/20 border border-[#292929]/25 rounded-[5px]">
            <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-[0.5rem]">
                    ...
                    <span className="text-[16px] text-[#292929] font-bold leading-none">Filename.pdf</span>
                </div>
            ...
            <div className="flex items-end justify-between w-full">
                ...
                <div className="flex items-center gap-[1rem]">
                    <div className='flex items-center gap-[0.2rem]'>
                        <button className='group cursor-pointer bg-[#f2f2f2] p-[0.3rem] rounded-[5px]'>
                            <Subtract className="size-5 opacity-50 group-hover:opacity-100 group-active:opacity-50" color='#292929'/>
                        </button>
                        <div className='flex items-center justify-center p-[0.5rem] w-[2rem] bg-[#ffdca5] rounded-[5px]'>
                            <span className='text-[16px] text-[#292929]/80 font-bold leading-none'>10</span>
                        </div>
                        <button className='group cursor-pointer bg-[#f2f2f2] p-[0.3rem] rounded-[5px]'>
                    ...
                    <button className='group cursor-pointer p-[0.3rem] bg-[#404040]/20 hover:bg-[#ffc36d] active:bg-[#404040]/20 rounded-[5px] transition-all duration-100'>
