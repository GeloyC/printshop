        ...
        <>
            <div className="flex flex-col w-full h-full bg-[#fff] overflow-y-auto thin-scrollbar rounded-t-[15px] p-[2rem] gap-[2rem] border border-[#404040]/25">
                <div className="flex items-start justify-between">
                    ...
                    <button className="flex items-center bg-[#ff6b00] hover:bg-[#ff810a] active:bg-[#ff6b00] rounded-[10px] p-[0.5rem] px-[0.75rem] cursor-pointer transition-all duration-100">
