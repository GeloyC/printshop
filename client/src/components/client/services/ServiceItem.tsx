...
function ServiceItem () {
    ...
    return (
        <Link to={'/service/slug'} className={`group relative grid grid-rows-[auto_auto] w-full h-[250px] rounded-[8px] bg-[#fff0d3]/0 hover:bg-[#fff0d3] p-[0.5rem] transition-all duration-200`}>
