    ...
    return (
        <>
            ...
            <div className="relative flex items-center w-full">
                <button onClick={()=>setDropdownOpen(open=>!open)} className="flex items-center justify-between w-full p-[0.75rem] bg-[#f2f2f2]/50 border border-[#292929]/15 hover:border-[#292929]/35 active:border-[#292929]/15 cursor-pointer">
                ...
                {dropdownOpen && (
                    <div className='absolute top-[100%] flex flex-col w-full bg-[#fff] shadow-md z-20'>
                        ...
                        <button onClick={()=>handleSelectOption('Select name 1')} className='flex items-center justify-between w-full p-[0.75rem] hover:bg-[#B1B2B5]/25 active:bg-transparent cursor-pointer'>
