...
function Toast ({ message }: ToastProp) {
    ...
    return (
        <div className="absolute left-1/2 -translate-x-1/2 bottom-12 toast-pop flex items-center justify-between min-w-[150px] gap-[0.3rem] p-[0.3rem] px-[0.5rem] border-2 border-[#FFFF00] bg-[#FFFF00] rounded-[5px] shadow-lg">
